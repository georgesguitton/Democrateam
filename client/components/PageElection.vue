  ...
  <div>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img
          src="https://th.bing.com/th/id/R4df180105dc4bea229839cf0ce8d85dd?rik=99BXfH9QgMRlzA&pid=ImgRaw"
          class="col-md-8"
        />
        <!-- Icon Divider-->
        <div class="divider-custom divider-light">
        ...
        <p class="masthead-subheading font-weight-light mb-0">
          {{ election.info.dateDebut }} - {{ election.info.dateFin }}
        </p>
      </div>
    </header>
    <!-- Portfolio Section-->
        ...
        <div class="album py-5 bg-light">
          <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div
                class="col"
                v-for="candidat in election.candidat"
                :key="election.candidat.idChoix"
              >
